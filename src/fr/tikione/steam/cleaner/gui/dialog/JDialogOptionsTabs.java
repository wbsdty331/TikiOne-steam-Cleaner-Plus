...
public class JDialogOptionsTabs extends JDialog {
    ...
    private void initComponents() {
        ...
        jPanelP1Layout.setHorizontalGroup(jPanelP1Layout.createParallelGroup(Alignment.LEADING)
            .addGroup(jPanelP1Layout.createSequentialGroup()
                ...
                .addGroup(jPanelP1Layout.createParallelGroup(Alignment.LEADING)
                    .addComponent(jLabelDescP1, GroupLayout.DEFAULT_SIZE, 491, Short.MAX_VALUE)
        ...
        jCheckBoxCheckForUpdatesAtStartup.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                jCheckBoxCheckForUpdatesAtStartupActionPerformed(evt);
            }
        });
    ...
    private void jCheckBoxCheckForUpdatesAtStartupActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jCheckBoxCheckForUpdatesAtStartupActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jCheckBoxCheckForUpdatesAtStartupActionPerformed
